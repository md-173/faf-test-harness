 ...
 * java.io.PrintStream, java.io.PrintStream)} writes the error and usage text to stderr and returns
 * one of the stable process exit codes in {@link com.faforever.testharness.game.config.ExitCodes}.
 */

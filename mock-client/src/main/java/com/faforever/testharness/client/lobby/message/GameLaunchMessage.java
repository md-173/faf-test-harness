 ...
 *
 * @param uid game ID
 * @param mod featured mod name (e.g. {@code "faf"}, {@code "ladder1v1"})
 * @param name game display name
 * @param initMode 0 = normal lobby, 1 = auto lobby (deprecated — infer from {@code gameType})
 * @param gameType {@code "coop"} / {@code "custom"} / {@code "matchmaker"}
 * @param ratingType e.g. {@code "global"}, {@code "ladder_1v1"}
...
public record GameLaunchMessage(
        ...
        String mod,
        String name,
        @JsonProperty("init_mode") int initMode,

 ...
 * rather than decoding the frame into a record. Consumers handling large or nested payloads should
 * prefer a typed record (see {@link com.faforever.testharness.client.lobby.message.WelcomeMessage}
 * / {@link com.faforever.testharness.client.lobby.message.GameLaunchMessage}) and let Jackson's
 * record-aware deserialisation do the same validation in one call.
 */

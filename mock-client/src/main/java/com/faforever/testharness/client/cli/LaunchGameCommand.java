...
/**
 * Stub for the {@code launch-game} subcommand. Eventually spawns {@code mock-game} only and
 * forwards its output through the harness logger; pairs with {@link LaunchIceCommand} to drive the
 * GPGNet handshake without lobby involvement.
 *
...
public final class LaunchGameCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        log.info("TODO: 'launch-game' not implemented yet");

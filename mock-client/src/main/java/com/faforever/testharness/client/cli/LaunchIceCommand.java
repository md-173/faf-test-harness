...
/**
 * Stub for the {@code launch-ice} subcommand. Eventually spawns {@code faf-ice-adapter} only and
 * forwards its output through the harness logger; useful as a lower-level diagnostic and as a
 * stepping stone when wiring up subprocess plumbing.
 *
...
public final class LaunchIceCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        log.info("TODO: 'launch-ice' not implemented yet");
